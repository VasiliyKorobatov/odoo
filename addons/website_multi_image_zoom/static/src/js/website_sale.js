odoo.define('website_multi_image_zoom.website_sale', function(require) {
    ...
    $(document).ready(function() {
        $('.oe_website_sale').each(function() {
            var demo = '<div class="xzoom-container"><img class="xzoom" id="xzoom-default" xoriginal="' + $('#ex1').find('img').attr("src") + '" style="width: 300px; height: 300px;" src="' + $('#ex1').find('img').attr("src") + '"/></div>';
            $('#ex1 span').html(demo);
