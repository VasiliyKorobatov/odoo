...
class Cdr(models.Model):
    ...
    from_partner_id = fields.Integer(compute='_get_from_partner_id', readonly=True, store=True, index=True)
    to_partner = fields.Many2one('res.partner', compute='_get_to_partner', readonly=True)
    to_partner_id = fields.Integer(compute='_get_to_partner_id', readonly=True, store=True, index=True )
